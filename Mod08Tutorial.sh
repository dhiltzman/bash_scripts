...
#write emp data to csv in mod08t dir
...
#sort and unique array of cities
...
#add last names to city array
echo "Adding last names, this will take awhile.."
echo "Go grab a beer or something."
...
#print out cities and last names in a clean form
clear
for i in ${city_array[*]}
do
...
#pack up into emp data csv into directory
cd ~/mod08t
tar -cf emp_data.tgz -z employee_data.csv
#return home
cd ~
